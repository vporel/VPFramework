...
class ServiceConfiguration{
    ...
    public function getService($name){
        ...
        if($this->services === null){
            ...
            $this->defaultAppServices = require Constants::FRAMEWORK_ROOT."/InternalApp/Config/services.php";
        }
        if($this->services !== null && array_key_exists($name, $this->services)){
            
            if($name == "security" || $name == "admin"){
                //Prise en compte des règles définies par le framework dans le dossier InternalApp (Ex:pour l'administration)
