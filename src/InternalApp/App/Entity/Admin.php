...
use VPFramework\Form\Annotations\{RelationField, PasswordField};
...
class Admin extends EntityWithId implements UserInterface
{
     ...
     * @ORM\ManyToOne(targetEntity="VPFramework\InternalApp\App\Entity\AdminGroup", inversedBy = "admins")
