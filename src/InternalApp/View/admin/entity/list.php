            ...
            <?php 
                foreach($elements as $element){ 
                    ...
                    foreach($filterFields as $fieldName){ 
                        ...
                        $dataForFilter .= 'data-'.$fieldName.'="';
                        if($field["type"] == "EnumField")
                            $dataForFilter .= $field["formAnnotation"]->getElements()[$value] ?? "";
                        elseif($value instanceof \DateTime) 
                            $dataForFilter .= $value->format("d-m-Y H:i"); 
                        else
                            $dataForFilter .= $value;
                        $dataForFilter .= '" ';
                    }
                ...
                <tr <?= $dataForFilter ?>>
                    ...
                    <?php foreach($mainFields as $fieldName => $field){ $value = $element->$fieldName;?>
                        <td class="<?= $fieldName ?>">
                            <?php
                                if($field["type"] == "EnumField")
                                    echo $field["formAnnotation"]->getElements()[$value] ?? "";
                                elseif($value instanceof \DateTime) 
        ...
        function applyFilter(){
            $("#list tbody tr").each(function(){
                ...
                for(fieldName in filtersRules){
                    if(!filtersRules[fieldName]($(this).attr("data-"+fieldName))){
                        correct = false;
                        break;
                    }
                }
