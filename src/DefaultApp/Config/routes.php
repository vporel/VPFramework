...
return [
    new RouteGroup("VPFramework\DefaultApp\App\Controller\AdminController", "/admin", [
    ...
    new RouteGroup("VPFramework\DefaultApp\App\Controller\EntityAdminController", "/admin/<entityName>", [
